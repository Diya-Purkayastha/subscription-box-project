  ...
  return (
    <div className=" card max-w-4xl mx-auto px-4 py-10 text-gray-800 shadow-lg my-5">
      ...
      <ul className=" card-body space-y-5 text-base leading-relaxed">
        <li>
          <strong className="text-primary">1. Data We Collect:</strong> Basic info like name, email, address, and subscription details.
        </li>
        <li>
        ...
        <li>
          <strong className="text-primary">8. Contact Us:</strong> Questions? Contact us at <a href="/" className="text-blue-600 underline">privacy@Subs.boX.com</a>
        </li>
      </ul>
    </div>
  );
